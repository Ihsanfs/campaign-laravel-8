        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 mt-4">
                    <div class="div">
                        <img src="{{ asset('artikel/' . $artikel->gambar_artikel) }}" class="img-fluid" alt="">
                    </div>
                ...
                <div class="col-lg-4 mt-4 ">
                    ...
                    <div class="detail-sidebar-iklan">
                        ...
                        <hr>
                        <a href="" ><img width="200px" src="{{asset('artikel/' . $iklan->gambar_iklan)}}"  alt=""></a>
                    ...
                    <div class="detail-sidebar-iklan">
                      <h4 class="mt-4">kategori</h4>
                        ...
                        <div class="sidebar-kategori d-flex flex-wrap">
                            <a href="{{route('blog.show',$item->slug)}}" style="color: black"><p>{{$item->nama_kategori}}</p></a>
                            <p class="ml-auto text-right badge badge-dark"><span class="badge badge-dark">{{$item->artikel->count()}}</span></p>
                        </div>
                        @endforeach
                    ...
                    <div class="detail-sidebar-iklan">
                        <h4 class="mt-4">artikel terbaru</h4>
                          ...
                          <div class="media mt-2">
                            <img class="mr-3" width="80px" src="{{asset('artikel/' . $item->gambar_artikel)}}" >
